...
\begin{proof}
  ...
  The relation is symmetric since the definition is symmetric with regard to $x$ and $y$.
...
\begin{theorem}
  Let $(X, T)$ be a minimal TDS with an invariant measure.
  Then $Q_2(X)$ is an ICER.
\end{theorem}